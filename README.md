...
- ![Madagascar distance rings](docs/screenshots/madagascar-distance-rings.png)
...
- ![Spain highlighted distance match](docs/screenshots/spain-highlighted-distance.png)

The globe view gives the same border-to-border distance result a more spatial, earth-scale presentation.

- ![Japan in globe mode](docs/screenshots/japan-globe-view.png)
...
- ![Paraguay with multiple country previews](docs/screenshots/paraguay-multi-country-preview.png)
